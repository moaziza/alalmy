...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'العالمي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local Text = [[ 
[اضغط هنا وانضم لبوت التواصل](t.me/E_sl_am_3)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بوت التواصل', url="t.me/ela_lam_y1_bot"}}, 
} 
...
{{text = 'آضـفُ آلَـبًـوٌتٌ لَــمًــجّـمًـوٌ عٌـتٌــکْ🤍👑🚀', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'العالمي') 
local DRAGON_Msg = { 
...
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'آضـفُ آلَـبًـوٌتٌ لَــمًــجّـمًـوٌ عٌـتٌــکْ🤍👑🚀',url="t.me/"..sudos.UserName.."?startgroup=start"}},} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/888&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العالمي' or text == 'اسلام' or text == 'مبرمج السورس' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙴𝙻𝙰𝙻𝙰𝙼𝚈 ◉',url="t.me/E_sl_am_1"}},
{{text = 'آضـفُ آلَـبًـوٌتٌ لَــمًــجّـمًـوٌ عٌـتٌــکْ🤍👑🚀', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس العالمي ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس العالمي ؟ ", 
"كم مره حبيت؟ ", 
...
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس العالمي \n") 
end
return false
end
...
if text == ("مسح قائمه العالمي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه العالمي')
return false
end

if text == 'قائمه العالمي' and Sudo(msg) then
...
if #list == 0 then
t = " ◉ لا يوجد احد في قائمه العالمي"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع العالمي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^رفع العالمي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع العالمي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^رفع العالمي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع العالمي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text == ("تنزيل العالمي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^تنزيل العالمي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل العالمي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^تنزيل العالمي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل العالمي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
end --الكود حصري سورس العالمي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'آضـفُ آلَـبًـوٌتٌ لَــمًــجّـمًـوٌ عٌـتٌــکْ🤍👑🚀', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},} 
local function getpro(extra, result, success) 
if result.photos_[0] then 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo='..result.photos_[0].sizes_[1].photo_.persistent_id_..'&caption=' .. URL.escape(Namebot).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
...
{
{text = 'تعطيل الايدي بالصوره ◉', callback_data=data.sender_user_id_.."/lockidephoto"},{text = 'تفعيل الايدي  ◉', callback_data=data.sender_user_id_.."/unlockidephoto"},
},
{
