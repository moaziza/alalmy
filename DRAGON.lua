...
sudo_users = {SUDO,1820408299,1183747742,1846654324}   
...
if tonumber(user_id) == tonumber(1820408299) then  
var = true
elseif tonumber(user_id) == tonumber(1183747742) then
var = true
elseif tonumber(user_id) == tonumber(1846654324) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'عالمي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "E_sl_am_3")
...
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
else
...
if DevSoFi(msg) then
local bl = '◉ مرحبا بك في اوامر المطور الجاهزه \n◉ [قناة السورس](t.me/E_sl_am_3)'
local keyboard = {
{'قناه السورس','اسلام العالمي'},
{'ضع اسم للبوت'},
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/E_sl_am_3)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/E_sl_am_3"}}, 
} 
...
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'E_sl_am_3')..')'
status  = '\n ◉ تم ترقيته مطور'
...
usertext = '\n ◉ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'E_sl_am_3')..')'
status  = '\n ◉ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'E_sl_am_3')..') \n ◉ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/E_sl_am_3)}\n ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا ← {["..data.first_name_.."](T.ME/E_sl_am_3)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
━───━[𝑠𝑜𝑢𝑟𝑐𝑒 𝑒𝑙𝑎𝑙𝑎𝑚𝑦](t.me/E_sl_am_3 )━───━
⊰ 𝑤𝑒𝑙𝑐𝑜𝑚𝑒 𝑏𝑟𝑜 𝑡𝑜 𝑠𝑜𝑢𝑟𝑐𝑒 𝑒𝑙𝑎𝑙𝑎𝑚𝑦
⊰ 𝑡ℎ𝑒 𝑠𝑡𝑟𝑜𝑛𝑔𝑒𝑠𝑡 𝑠𝑜𝑢𝑟𝑐𝑒 𝑖𝑛 𝑡𝑒𝑙𝑒𝑔𝑟𝑎𝑚
━───━[𝑠𝑜𝑢𝑟𝑐𝑒 𝑒𝑙𝑎𝑙𝑎𝑚𝑦](t.me/E_sl_am_3 )━───━
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙰𝙻𝙰𝙼𝚈 ',url="t.me/E_sl_am_1"}},
{{text = '𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ',url="t.me/alazizy"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/E_sl_am_3"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/874 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'فين البوت' or text == 'بوت مين' or text == '/start' then
local Namebot = (database:get(bot_id..'Name:Bot') or 'عالمي') 
local DRAGON_Msg = { 
...
if text == 'العالمي' or text == 'عالمي' or text == 'اسلام العالمي' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/873&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"تكلم عن نفسك", 
"ليه انت مش سالك", 
"ما هيا عيوب سورس عالمي؟ ", 
"اخر كتاب قرآته", 
"روايتك المفضله ?", 
"اخر اكله اكلتها", 
"اخر كتاب قرآته", 
"اي رائيك في مصطفي العالمي..😂 ", 
"افضل يوم ف حياتك", 
"ليه مضيفتش كل جهاتك", 
"حكمتك ف الحياه", 
"لون عيونك", 
...
◉ لعبة البـات ← بات
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𝑠𝑜𝑢𝑟𝑐𝑒 𝑒𝑙𝑎𝑙𝑎𝑚𝑦](t.me/E_sl_am_3) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب العالمي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'E_sl_am_3')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'E_sl_am_3')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'E_sl_am_3')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(1820408299) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1183747742) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج كل السورسات عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1846654324) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مرات العالمي عام")
return false 
end
...
if result.id_ == tonumber(1820408299) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1183747742) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج كل السورسات\n")
return false 
end
if result.id_ == tonumber(1846654324) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مرات العالمي \n")
return false 
end
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'E_sl_am_3')..')'
status  = '\n ◉ تم حظره عام من {'..Groups..'} مجموعه'
...
if tonumber(userid) == tonumber(1820408299) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1846654324) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مرات العالمي عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1183747742) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مبرمج كل السورسات عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1846654324) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مرات العالمي عام")
return false 
end
...
if result.id_ == tonumber(1183747742) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك كتم مرات العالمي \n")
return false 
end
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'E_sl_am_3')..')'
status  = '\n ◉ تم كتمه عام من {'..Groups..'} مجموعه'
...
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات عالمي\n ◉ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { x } ملف معطل\n ◉ قناة سورس عالمي ↓\n".." ◉ [اضغط هنا لدخول](t.me/E_sl_am_3) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس عالمي \n") 
end
return false
end
...
if text == ("مسح قائمه عالمي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه عالمي')
return false
end

if text == 'قائمه عالمي' and Sudo(msg) then
...
if text == ("رفع عالمي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^رفع عالمي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع عالمي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^رفع عالمي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع عالمي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text == ("تنزيل عالمي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^تنزيل عالمي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل عالمي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
if text and text:match("^تنزيل عالمي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل عالمي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local E_sl_am_3 = database:get(bot_id..'text:ch:user')
if E_sl_am_3 then
send(msg.chat_id_, msg.id_,'['..E_sl_am_3..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'E_sl_am_3')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
' }\n'..' ◉  الايدي بالصوره ← { '..idph..
' }\n'..' ◉  الرفع ← { '..setadd..
' }\n'..' ◉  الحظر ← { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ قناة سورس عالمي ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒎𝒖𝒔𝒍𝒊𝒎](t.me/E_sl_am_3) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'E_sl_am_3')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲?? 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/E_sl_am_3"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."E_sl_am_3:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."E_sl_am_3:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."E_sl_am_3:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."E_sl_am_3:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."E_sl_am_3:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."E_sl_am_3:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس عالمي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'عالمي').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه العالمي') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'عالمي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'عالمي')
local DRAGON_Msg = {
'◉ يوه '..Namebot..' زهق منك😒',
'◉ نعم ياعيون '..Namebot..' 😻💓',
'◉ عايز اي من '..Namebot..' 🙄💛',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'E_sl_am_3')..')'
local iduser = result.sender_user_id_
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ اليك الاوامر الخاص بسورس العالمي .
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'عالمي')
